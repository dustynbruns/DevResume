    ...
    return (
        <Container>
            <Col className="page-title">
                <h1>My Projects</h1>
                <br />
                <p>Here are some of my projects! Click on any one of the projects that you would like to see, and you will be navigated to my Github Repository!</p>
            </Col>
            <div xs={1} md={2} className="projects-container">
